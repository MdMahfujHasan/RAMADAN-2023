document.getElementById('btn-update').addEventListener('click', function () {
    ...
    if (dateNumber === 28) {
        gregorianDate.innerText = 28 + 'th March';
        hijriDate.innerText = 5 + 'th Ramadan';
        iftarSehri.innerHTML = `
        <h2 style="color: tomato;">**Dhaka time**</h2>
        <h3>Sehri at 4:34 am</h3>
        <h3>Iftar at 6:16 pm</h3>
        `;
    }
