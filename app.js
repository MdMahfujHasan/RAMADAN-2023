document.getElementById('btn-update').addEventListener('click', function () {
    ...
    if (dateNumber === 29) {
        ...
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:17 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:31 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:17 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:30 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:18 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:29 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:18 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:28 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:19 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:27 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:19 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:26 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:19 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:24 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:20 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:23 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:21 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:22 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:21 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:21 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:21 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:20 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:22 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:19 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:22 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:18 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:23 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:17 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:23 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:15 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:23 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:14 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:24 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:13 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:24 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:12 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:24 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:11 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:25 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:10 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:25 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:09 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:26 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:08 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:26 pm</h3>
        `;
    }
        ...
        iftarSehri.innerHTML = `
        <h2 class="text-red-500 font-medium text-center mt-2">**Dhaka time**</h2>
        <h3 class="text-cyan-500 font-bold text-center">Sehri at 4:07 am</h3>
        <h3 class="text-violet-500 font-bold text-center">Iftar at 18:27 pm</h3>
        `;
    }
})
